...
Loaded and tidied the _accel_data_. Created a final dataset, _acc_data_long_ that includes the same variables and values, just in a longer and tidied format.
