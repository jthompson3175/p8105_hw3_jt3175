...
Loading the *Instacart* data and pulling a random sample for an example:
...
Loaded in the *brfss\_smart2010* data and cleaned it. Created a new
dataset, *brfss*, that only contained the “Overall Health” topic and
responses from “Poor” to “Excellent”, which were organized in ascending
order that way as a factor variable.
...
Loaded and tidied the *accel\_data*. Created a final dataset,
*acc\_data\_long* that includes the same variables and values, just in a
longer and tidied format.
...
<img src="p8105_hw3_jt3175_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />
...
<img src="p8105_hw3_jt3175_files/figure-gfm/unnamed-chunk-15-1.png" width="90%" />
...
<img src="p8105_hw3_jt3175_files/figure-gfm/unnamed-chunk-15-2.png" width="90%" />
